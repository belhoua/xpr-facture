...
final class DemoSeeder extends Seeder
{
    ...
    private function seedCatalog(string $companyId): array
    {
        ...
        $catalog = [
            ...
            ['category' => 'Licences & abonnements', 'color' => '#7C3AED', 'name' => 'Licence logicielle BCAT', 'reference' => 'LIC-BCAT', 'type' => 'service', 'unit' => 'an', 'price' => 1_200_000, 'cost' => null, 'tax' => $standard],
